...
import { Store, Lock, Mail, RefreshCw, AlertCircle } from "lucide-react";
    ...
    <Card className="w-full max-w-md shadow-md border-border bg-card">
      <CardHeader className="space-y-2 text-center pb-4">
        ...
        <CardDescription className="text-sm">
          Sign in to your merchant portal &amp; AI Agent Builder.
        </CardDescription>
      </CardHeader>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <CardFooter className="flex flex-col gap-3 pt-2">
          ...
          <div className="text-xs text-center text-muted-foreground pt-1">
            New Merchant?{" "}
            <Link href="/merchant/register" className="text-primary font-medium hover:underline">
